...
from utils.graph_utils import get_circuit_unitaries
...
def unroll_gate_common_phases(self):
    ...
    while self.is_common_phase_present():
        ...
        index += 1
    print("GATE PHASE UNROLLING HAS BEEN DONE")
    ...
    while optimization_possible:
        ...
        while True:
            ...
            if len(resulting_merges) == 0:
                break
        print("mergable gates")
        c, _ = self.build_circuit(breakdown="v")
        # print(c)
        ...
        print("Swap info: ", status1, status2, status3)
...
'''TODO: This peice of code is missing Rule 4'''
